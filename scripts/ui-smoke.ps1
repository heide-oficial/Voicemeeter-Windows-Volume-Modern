...
Test-UI "Update status card exists" { winapp ui wait-for "UpdateStatusCard" -a $AppPid -t 5000 }
...
Test-UI "Language selector exists" { winapp ui wait-for "CmbLanguage" -a $AppPid -t 5000 }
